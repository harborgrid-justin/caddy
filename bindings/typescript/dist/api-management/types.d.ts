...
export type RateLimitType = 'fixed_window' | 'sliding_window' | 'token_bucket' | 'leaky_bucket' | 'concurrent';
...
export type CodeLanguage = 'typescript' | 'javascript' | 'python' | 'java' | 'go' | 'rust' | 'csharp' | 'php' | 'ruby' | 'curl';
