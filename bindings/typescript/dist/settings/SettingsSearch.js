...
const SettingsSearch = ({ query, onQueryChange, onClose, onNavigate, }) => {
    ...
    return (React.createElement("div", { style: {
            ...
            padding: '10vh 1rem',
            zIndex: 2000,
        }, onClick: onClose, role: "dialog", "aria-modal": "true", "aria-labelledby": "search-title" },
        React.createElement("div", { onClick: (e) => e.stopPropagation(), style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("div", { style: { position: 'relative' } },
                    ...
                    React.createElement("input", { ref: inputRef, type: "text", value: query, onChange: (e) => onQueryChange(e.target.value), onKeyDown: handleKeyDown, placeholder: "Search settings...", "aria-label": "Search settings", "aria-describedby": "search-help", style: {
                            width: '100%',
                ...
                React.createElement("div", { id: "search-help", style: {
                        marginTop: '0.5rem',
                        fontSize: '0.75rem',
                        color: '#666',
                        display: 'flex',
            ...
            React.createElement("div", { ref: resultsContainerRef, style: {
                    flex: 1,
                    overflowY: 'auto',
                    padding: '0.5rem',
                }, role: "listbox", "aria-label": "Search results" },
                results.length === 0 && query.trim() !== '' && (React.createElement("div", { style: {
                        padding: '2rem',
                        textAlign: 'center',
                        color: '#666',
                    }, role: "status" },
                ...
                results.length === 0 && query.trim() === '' && (React.createElement("div", { style: {
                    ...
                    React.createElement("p", { style: { margin: '0 0 1rem 0' } }, "Type to search settings..."),
                    React.createElement("div", { style: { fontSize: '0.875rem' } },
                        React.createElement("p", { style: { margin: '0.5rem 0' } }, "Try searching for:"),
                        React.createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: '0.5rem', justifyContent: 'center' } }, ['password', 'email', 'api', 'team', 'billing', 'security'].map((term) => (React.createElement("button", { key: term, onClick: () => onQueryChange(term), style: {
                ...
                results.map((result, index) => (React.createElement("div", { key: `${result.section}-${result.title}`, "data-index": index, onClick: () => onNavigate(result.path), role: "option", "aria-selected": index === selectedIndex, style: {
                        padding: '0.75rem',
                        borderRadius: '4px',
                    ...
                    React.createElement("div", { style: {
                            ...
                            __html: result.matches.find((m) => m.field === 'description')?.highlight ||
                                result.description,
                        } }),
                    result.matches.some((m) => m.field === 'keyword') && (React.createElement("div", { style: { marginTop: '0.25rem', fontSize: '0.75rem', color: '#999' } },
                        "Keywords:",
                        ' ',
                        result.matches
