/**
 * CADDY v0.4.0 - Enterprise Reporting System Types
 * $650M Platform - Production Ready
 *
 * Comprehensive type definitions for the reporting system including
 * report definitions, data sources, scheduling, and export configurations.
 */
