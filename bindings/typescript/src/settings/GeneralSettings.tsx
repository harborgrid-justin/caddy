/**
 * CADDY v0.4.0 Enterprise General Settings
 * App name, timezone, locale, branding configuration
 */
...
const GeneralSettings: React.FC<GeneralSettingsProps> = ({
  ...
  const [formState, setFormState] = useState<FormState<GeneralSettingsType>>({
    values: settings,
    errors: [],
    isDirty: false,
    isSubmitting: false,
  ...
  const [undoRedo, setUndoRedo] = useState<UndoRedoState<GeneralSettingsType>>({
    past: [],
    present: settings,
    future: [],
  });
  ...
  // Validation
  const validate = useCallback((data: GeneralSettingsType): ValidationError[] => {
    ...
    // IP validation for maintenance mode
  ...
  return (
    <div style={{ maxWidth: '800px' }}>
      <div style={{ marginBottom: '2rem' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '0.5rem' }}>General Settings</h2>
        <p style={{ color: '#666', margin: 0 }}>
          Configure application name, timezone, locale, and branding
        </p>
      </div>
      ...
      >
        <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>Basic Information</h3>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          >
            Application Name <span style={{ color: '#d32f2f' }}>*</span>
          </label>
          <input
            id="appName"
            type="text"
            ...
            aria-invalid={!!getFieldError('appName')}
            aria-describedby={getFieldError('appName') ? 'appName-error' : undefined}
            style={{
              width: '100%',
              padding: '0.5rem',
          ...
          {getFieldError('appName') && (
            <div
              id="appName-error"
              role="alert"
              style={{ color: '#d32f2f', fontSize: '0.875rem', marginTop: '0.25rem' }}
            >
              {getFieldError('appName')}
            </div>
          )}
      ...
      >
        <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>Regional Settings</h3>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
          ...
          <div>
            ...
            <select
              id="dateFormat"
              value={formState.values.dateFormat}
          ...
          <div>
            ...
            <select
              id="timeFormat"
              value={formState.values.timeFormat}
      ...
      >
        <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>Branding</h3>
        ...
        <div style={{ marginBottom: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            {formState.values.branding.logo && (
              <img
                src={formState.values.branding.logo}
                alt="Current logo"
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <input
                id="primaryColor"
                type="color"
                value={formState.values.branding.primaryColor}
                onChange={(e) => updateField('branding.primaryColor', e.target.value)}
                style={{ width: '50px', height: '38px', border: '1px solid #d0d0d0', cursor: 'pointer' }}
              />
              <input
                type="text"
                value={formState.values.branding.primaryColor}
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <input
                id="secondaryColor"
                type="color"
                value={formState.values.branding.secondaryColor}
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.5rem' }}>
              <input
                id="accentColor"
                type="color"
                value={formState.values.branding.accentColor}
      ...
      >
        <h3 style={{ fontSize: '1.125rem', marginBottom: '1rem' }}>Maintenance Mode</h3>

        <div style={{ marginBottom: '1rem' }}>
          <label style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
            <input
              type="checkbox"
              checked={formState.values.maintenance.enabled}
        ...
        {formState.values.maintenance.enabled && (
          <>
            <div style={{ marginBottom: '1rem' }}>
              <label
              ...
              <textarea
                ...
                value={formState.values.maintenance.message}
            ...
            <div>
              ...
              <textarea
                id="allowedIPs"
                value={formState.values.maintenance.allowedIPs.join('\n')}
                onChange={(e) =>
                  updateField(
